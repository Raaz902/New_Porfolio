          ...
          <div className="flex justify-center items-center">
            <div className="max-w-lg">
              ...
              <div className="mt-6 flex justify-between flex-wrap">
                <a href="https://wa.me/919750916786" target="_blank" rel="noopener noreferrer"> <span
                ...
                >
                  <button
                    ...
                    className="block md:hidden cursor-pointer text-white bg-green-500 hover:bg-green-600 transition duration-300 rounded-full md:py-3 md:px-6 px-4 py-2 font-bold shadow-lg"
                  >
                    RESUME
                  </button>
                </a>
